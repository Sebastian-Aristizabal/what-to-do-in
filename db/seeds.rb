...
plan_2 = Plan.new(title:"Jardín Botánico de Medellín", video_url:"", details:"Jardín Botánico de Medellín", end_date:"", start_date:"", start_hour:"23:59:59", end_hour:"00:00:00", address:"Cl. 73 #51d-14, Medellín, Aranjuez", link_web:"www.botanicomedellin.org", instagram_link:"www.instagram.com/jardinbotanicodemedellin", facebook_link:"", free: true, category_id: category_1.id, user_id: user_1.id)
...
plan_3 = Plan.new(title:"Parque arvi", video_url:"", details:"Un recorrido lleno de historia, naturaleza y mucha agua, caminaremos por senderos veredales, contemplando el paisaje rural de nuestras montañas antioqueñas", end_date:"", start_date:"", start_hour:"00:00:00", end_hour:"23:59:59", address:"SantaElena", link_web:"https://www.parquearvi.org/Paginas/index.aspx", instagram_link:"https://www.instagram.com/parquearvi/", facebook_link: "", free: true, category_id: category_2.id,  user_id: user_2.id)
...
plan_4 = Plan.new(title:"Lago Normandia", video_url:"", details:"Un recorrido lleno de historia, naturaleza y mucha agua, caminaremos por senderos veredales, contemplando el paisaje rural de nuestras montañas antioqueñas", end_date:"", start_date:"", start_hour:"00:00:00", end_hour:"23:59:59", address:"El retiro - Envigado", link_web:"", instagram_link:"https://www.instagram.com/viajeapie_", facebook_link: "", free: true,  category_id: category_2.id, user_id: user_2.id)
...
plan_6 = Plan.new(title:" El pilon de la villa", video_url:"", details:"Restaurante de comida rapida", end_date:"", start_date:"", start_hour:"17:00:00", end_hour:"23:59:59", address:"Carrera 80, Calle 32 B", link_web:"", instagram_link:"https://www.instagram.com/elpilondelavilla/", facebook_link: "", free: false, category_id: category_3.id , user_id: user_3.id)
...
plan_7 = Plan.new(title:"cacique Bar", video_url:"", details:"la mejor musica vallenata del mundo, y los mejores temas  Diomedes Dias ", end_date:"", start_date:"21:00:00", start_hour:"04:00:00", end_hour:"", address:"Carrera 70, Av. San Juan #44-34", link_web:"http://elcacique.com.co", instagram_link:"https://www.instagram.com/elcaciquebar/?hl=es", facebook_link: "",  free: false, category_id: category_4.id,  user_id: user_4.id )
